    ...
    MaterialTheme {
        Column(
            ...
            Row (
                ...
                val tagNames01 = listOf("컴포넌트", "성능")
                TaskCard("LazyColumn 컴포넌트 구현", "세로 스크롤 가능한 리스트 컴포넌트를 만들고 성능 최적화를 적용합니다.", tagNames01, "다이노")
            ...
            Row () {
                ...
                TaskCard(
                    ...
                    "너무너무 긴 설명은 두 줄까지만 노출하고 말줄임표로 처리합니다. 너무너무 긴 설명은 두 줄깢만 노출하고 말줄임표로 처리합니다.",
                    tagNames05,
